...
/**
 * Apenas teste para mostrar pro Rodrigo
 * @author 808012
 */
public class FrameTeste extends javax.swing.JFrame {
    ...
    public void initModel() {
        DefaultTableModel tmp = new DefaultTableModel(new String[] {"Um","Dois","Tres","Quatro"}, 0);
        tmp.addRow(new String[] {"1vlr1","1vlr2","1vlr3","1vlr4"});
        tmp.addRow(new String[] {"2vlr1","2vlr2","2vlr3","2vlr4"});
